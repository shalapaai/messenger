...
public sealed class RegisterCommandValidatorTests
{
    ...
    {
        var command = new RegisterCommand(email, "SecurePass1!");
    ...
    public void Validate_WithEmailExceeding255Chars_HasEmailError()
    {
        ...
        var command = new RegisterCommand(longEmail, "SecurePass1!");
    ...
    {
        var command = new RegisterCommand("user@example.com", "12345678");
    ...
    public void Validate_WithPasswordExceeding128Chars_HasPasswordError()
    {
        ...
        var command  = new RegisterCommand("user@example.com", longPass);
